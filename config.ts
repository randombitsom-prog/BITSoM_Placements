...
export const AI_NAME = "PlacementStats";
export const OWNER_NAME = "Sahil and Sanskaar";
...
export const PINECONE_TOP_K = 15; // Reduced to stay within token limits
export const PINECONE_INDEX_NAME = "ipcs";
